...
from app.domains.users.actions import get_by_id, update, create, get, delete
...
class TestUsersActions(unittest.TestCase):
    ...
    @patch('app.domains.users.actions.commit')
    @patch('app.domains.users.actions.get_by_id')
    def test_action_delete_should_delete_user(self, get_by_id_mock, commit_mock, user_mock):
        # Arrange
        user_mock.id = '42567345290'
        user_mock.name = 'Guilherme Kramer'
        user_mock.is_active = True
        get_by_id_mock.return_value = user_mock
